              ...
              <div key={section} style={{ position: "relative", marginBottom: "1.5rem" }}>
                ...
                {section === 'experience' &&
                  sectionSettings.experience.showExperience && (
                    <div>
                      ...
                      {((editMode ? localData : resumeData).experience || []).map((exp, idx) => (
                            ...
                            <ul>
                              {exp.accomplishment.map((acc, accIdx) => (
                                <li
                                  ...
                                  contentEditable={editMode}
                                  onBlur={(e) => {
                                    const updatedExp = [...(editMode ? localData : resumeData).experience];
                                    updatedExp[idx].accomplishment[accIdx] = e.target.textContent;
                                    handleInputChange('experience', 'accomplishment', updatedExp[idx].accomplishment, idx);
                                  }}
                                  style={{
                                    fontSize: "0.875rem",
                                    color: "#374151"
                ...
                {section === 'education' &&
                  sectionSettings.education.showEducation && (
                    <div>
                      ...
                      {((editMode ? localData : resumeData).education || []).map((edu, idx) => (
                        <div key={idx} style={{ marginBottom: "1rem" }}>
                          <h3
                            contentEditable={editMode}
                            onBlur={(e) =>
                ...
                {section === 'achievements' &&
                  sectionSettings.achievements.showAchievements && (
                    <div>
                      ...
                      {((editMode ? localData : resumeData).achievements || []).map((achievement, idx) => (
                        <div key={idx} style={{ marginBottom: "1rem" }}>
                          {typeof achievement === 'object' ? (
                            ...
                            <p
                              contentEditable={editMode}
                              onBlur={(e) => {
                                const updatedAchievements = [...(editMode ? localData : resumeData).achievements];
                                updatedAchievements[idx] = e.target.textContent;
                                handleInputChange(null, 'achievements', updatedAchievements);
                              }}
                              style={{
                                fontSize: "0.875rem",
                                color: "#374151"
                ...
                {section === 'skills' && sectionSettings.skills.showSkills && (
                  <div>
                    ...
                    <ul style={{ listStyle: "disc", paddingLeft: "1.25rem", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.5rem" }} className="list-disc pl-5 grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {((editMode ? localData : resumeData).skills || []).map((skill, idx) => (
                        <li key={`${skill}-${idx}`} style={{ display: "flex", alignItems: "center" }} className="flex items-center">
                          <span
                            contentEditable={editMode}
                            suppressContentEditableWarning
                            onBlur={(e) => {
                              const updatedSkills = [...(editMode ? localData : resumeData).skills];
                ...
                {section === 'courses' && sectionSettings.courses.showCourses && (
                  <div>
                    ...
                    {((editMode ? localData : resumeData).courses || []).map((course, idx) => (
                      <div key={idx} style={{ marginBottom: "1rem" }}>
                        <h3
                          contentEditable={editMode}
                          onBlur={(e) =>
                ...
                {section === 'projects' &&
                  sectionSettings.projects.showProjects && (
                    <div>
                      ...
                      {((editMode ? localData : resumeData).projects || []).map((project, idx) => (
                        <div key={idx} style={{ marginBottom: "1rem" }}>
                          <h3
                            contentEditable={editMode}
                            onBlur={(e) =>
                          ...
                          {(project.link || project.github) && (
                            <div style={{ marginTop: "0.5rem" }}>
                              {project.link && (
                                <a href={project.link} target="_blank" rel="noopener noreferrer" style={{ color: "#3b82f6", marginRight: "1rem" }}>
                                  Live Demo
                                </a>
                              )}
                              {project.github && (
                                <a href={project.github} target="_blank" rel="noopener noreferrer" style={{ color: "#3b82f6" }}>
                                  GitHub
                                </a>
                              )}
                            </div>
